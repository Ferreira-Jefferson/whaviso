...
7. **`wa.me` do Whaviso (H2.2):** o link de convite aponta para o **número do WhatsApp do Whaviso** (Baileys) com texto pré-preenchido. Confirmar de onde vem esse número (env/config) para o front montar o link.
